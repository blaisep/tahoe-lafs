...
The goal is to learn Tahoe
--------------------------

If you are new to Tahoe, these docs will give you a concrete experience operating Tahoe.
Each section provides exercises, expanding on the previous examples, so that you can:
